...
namespace Assets.Scripts.Network.GUI
{
    public class MyGUI : MonoBehaviour
    {
        ...
        [Header("Main Window")]
        [SerializeField]
        private Button     _buttonSetupAServer;
        [SerializeField]
        private Button     _buttonConnectToAServer;
        [SerializeField]
        ...
        [Header("Setup Server")]
        [SerializeField]
        private Button     _buttonSetupAPublicServer;
        [SerializeField]
        private Button     _buttonSetupAPrivateServer;

        // Public
        [Header("Setup Server Public")]
        [SerializeField]
        private GameObject _setupAPublicServerPanel;
        [SerializeField]
        private InputField _inputFieldNameAPublicServer;
        [SerializeField]
        private Button     _buttonStartAPublicServer;
        ...
        [SerializeField]
        private Button     _buttonConnectToAPublicServer;
        [SerializeField]
        private Button     _buttonConnectToAPrivateServer;

        // Public
        [Header("Connect Public Server")]
        [SerializeField]
        private GameObject _connectToAPublicServerPanel;
        [SerializeField]
        private InputField _inputFieldPseudoForPublicServer;
        [SerializeField]
        private Button     _buttonRefreshListPublicServer;
        [SerializeField]
        private GameObject _prefabPublicServer;
        [SerializeField]
        private GameObject _PanelListPublicServer;
